		...
		<div id="split-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-split">
			...
			<form id="split_topic" name="split_topic" method="post" action="<?php the_permalink(); ?>">
				...
				<fieldset class="bbp-form">
					...
					<legend><h2><?php printf( __( 'Split topic "%s"', 'bbpress' ), bbp_get_topic_title() ); ?></h2></legend>
					...
					<div>
						...
						<fieldset class="bbp-form">
							<legend><h2><?php _e( 'Split Method', 'bbpress' ); ?></h2></legend>
						...
						<fieldset class="bbp-form">
							<legend><h2><?php _e( 'Topic Extras', 'bbpress' ); ?></h2></legend>
