 ...
 *
 * This file contains a class to create the Blog Author widget.
 *
 * @package   Flatbase
...
class Nice_BlogAuthor extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<p><?php echo $bio; ?></p>
			<?php if ( $read_more_url ) echo '<p><a href="' . esc_url( $read_more_url ) . '">' . $read_more_text . '</a></p>'; ?>
			<?php if ( $twitter ) echo '<p><a href="http://twitter.com/' . esc_url( $twitter ) . '" class="twitter">' . __('Follow me on twitter', 'nicethemes') . '</a></p>'; ?>
			<div class="fix"></div>
	...
	function form($instance) {
		...
		<p>
			...
			<textarea name="<?php echo esc_attr( $this->get_field_name('bio') ); ?>" class="widefat" id="<?php echo esc_attr( $this->get_field_id('bio') ); ?>"><?php echo $bio; ?></textarea>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e( '<a href="http://twitter.com/">Twitter</a> Username:','nicethemes' ); ?></label>
			<input type="text" name="<?php echo esc_attr( $this->get_field_name('twitter') ); ?>"  value="<?php echo $twitter; ?>" class="widefat" id="<?php echo esc_attr( $this->get_field_id('twitter') ); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('custom_email'); ?>"><?php _e( '<a href="http://www.gravatar.com/">Gravatar</a> E-mail:','nicethemes' ); ?></label>
			<input type="text" name="<?php echo esc_attr( $this->get_field_name('custom_email') ); ?>"  value="<?php echo $custom_email; ?>" class="widefat" id="<?php echo esc_attr( $this->get_field_id('custom_email') ); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('avatar_size'); ?>"><?php _e( 'Gravatar Size:','nicethemes' ); ?></label>
			<input type="text" name="<?php echo esc_attr( $this->get_field_name('avatar_size') ); ?>"  value="<?php echo $avatar_size; ?>" class="widefat" id="<?php echo esc_attr( $this->get_field_id('avatar_size') ); ?>" />
		</p>
		<p>
		...
		<p>
			...
			<input type="text" name="<?php echo esc_attr( $this->get_field_name('read_more_text') ); ?>"  value="<?php echo $read_more_text; ?>" class="widefat" id="<?php echo esc_attr( $this->get_field_id('read_more_text') ); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('read_more_url'); ?>"><?php _e( 'Read More URL (optional):','nicethemes' ); ?></label>
			<input type="text" name="<?php echo esc_attr( $this->get_field_name('read_more_url') ); ?>"  value="<?php echo $read_more_url; ?>" class="widefat" id="<?php echo esc_attr( $this->get_field_id('read_more_url') ); ?>" />
		</p>
		<p>
