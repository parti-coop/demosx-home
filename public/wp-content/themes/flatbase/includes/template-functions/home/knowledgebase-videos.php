...
if ( ! function_exists( 'nice_homepage_knowledgebase_videos' ) ) :
/**
 ...
 * @return string
 */
function nice_homepage_knowledgebase_videos( $echo = true ) {
	// Allow bypass.
	if ( $output = apply_filters( 'nice_homepage_knowledgebase_videos', '' ) ) {
		return $output;
	}
	...
	//if ( nice_bool( nice_get_option( 'nice_homepage_infoboxes' ) ) ) {
		get_template_part( 'template-parts/home/knowledgebase_videos' );
	//}
