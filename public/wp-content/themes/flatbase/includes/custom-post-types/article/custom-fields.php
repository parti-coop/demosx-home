 ...
 *
 * This file contains the function to hook custom fields for articles.
 *
 * @package   Flatbase
...
if ( ! function_exists( 'nice_custom_fields_article' ) ) :
add_filter( 'nice_custom_fields', 'nice_custom_fields_article', 10, 2 );
/**
 ...
 * @return array
 */
function nice_custom_fields_article( array $nice_fields = array(), $post_type ) {
